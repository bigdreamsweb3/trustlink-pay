...
const feeRows = [
  ...
  ["TSN protocol fee", "policy-based", "The sender-side protocol fee is split between TSN protocol revenue and vault pool yield."],
      ...
      <section id="fee-model" className="mx-auto grid w-full max-w-[1180px] scroll-mt-28 gap-5 py-12 lg:grid-cols-[0.9fr_1.1fr]">
        <div>
          ...
          <p className="mt-4 text-sm leading-7 text-[var(--text-soft)]">
            Sender quotes should stay honest: current Solana transaction fee, plus the TSN protocol fee from the active fee config. The sender-side protocol fee can support TSN operations while also allocating yield to vault funders. Claim fees stay inside the settlement economy: part covers Cranker operator uptime and execution costs, while the rest rewards vault pool funders. Verifier-paid setup for escrow, vault, and recoverable protocol accounts stays an operating cost; unrecoverable recipient account setup belongs on the claim side.
          </p>
        </div>
