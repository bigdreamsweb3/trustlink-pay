...
pub fn initialize_mother_escrow(
    ...
    mother_escrow.tin_fee_split_verify_cranker_bps = default_tin_verify_cranker;
    mother_escrow.tin_fee_split_submit_cranker_bps = default_tin_submit_cranker;
    mother_escrow.tin_fee_split_team_bps = default_tin_team;
    mother_escrow.tin_fee_split_reserve_pool_bps = default_tin_reserve_pool;
