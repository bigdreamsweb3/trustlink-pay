...
// Code snippet for developers section
const codeLines = [
...
export function LandingPage() {
  ...
  return (
    <main className="app-shell overflow-hidden text-[14px] md:text-[15px]">
      ...
      {/* HERO SECTION */}
      <section id="tsn-protocol" className="mx-auto grid min-h-[calc(100dvh-7rem)] w-full max-w-[1180px] scroll-mt-28 items-center gap-10 px-2 pb-8 pt-2 lg:grid-cols-[0.98fr_1.02fr]">
        <div className="relative z-10">
          <div className="tl-meta-label text-nowrap whitespace-nowrap">
            Transfer Settlement Network · Solana
          </div>
          <h1 className="tl-display mt-4 max-w-[760px]">
            TrustLink Pay —{" "}
          ...
          <p className="tl-body-lg mt-4 pr-3 max-w-[680px] text-[var(--text-soft)]">
        ...
        <div id="how-it-works-hero" className="relative z-10 grid gap-3 w-full scroll-mt-28">
          ...
          <div className="grid grid-cols-2 gap-2">
            {heroStats.map((stat) => (
              <div key={stat.label} className="tl-field rounded-[14px] px-3 py-2.5">
                <p className="text-[0.62rem] font-semibold uppercase tracking-[0.14em] text-[var(--text-faint)]">{stat.label}</p>
                <strong className="mt-1 block text-lg font-black text-[var(--text)]">{stat.value}</strong>
                <span className="mt-0.5 block text-[0.68rem] leading-4 text-[var(--muted)]">{stat.note}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="identity-first" className="mx-auto grid w-full max-w-[1180px] scroll-mt-28 gap-6 px-2 py-8 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-0">
        <div className="min-w-0">
          <SectionLabel index="01" title="Identity-First Payments" />
          <h2 className="tl-h2 mt-4 text-balance">
            The world already understands how to pay people through identity.
          </h2>
          <p className="tl-body mt-3 max-w-[680px]">
            Nigeria uses OPay.<br />
            India uses UPI.<br />
            Brazil uses Pix.
          </p>
        </div>
        <div className="tl-panel overflow-hidden rounded-[18px] px-5 py-5 flex flex-col justify-center">
          <p className="text-[0.92rem] leading-7 text-[var(--text-soft)]">
      ...
      <section id="tin-system" className="mx-auto w-full max-w-[1180px] scroll-mt-28 px-2 py-8 sm:px-6 lg:px-0">
        ...
        <div className="mt-4 grid gap-6 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-3 text-[0.875rem] leading-7 text-[var(--text-soft)]">
            ...
            <div className="mt-4 px-4 py-3 tl-field rounded-[14px]">
              <p className="text-[0.62rem] font-bold uppercase tracking-wider text-[var(--text-faint)] mb-1">Example TIN</p>
              <p className="text-xl font-mono font-bold text-accent">4872-1930-41</p>
            </div>
          </div>
          <div className="grid gap-3">
            {[
              ...
              <div key={title} className="tl-panel rounded-[18px] px-4 py-3 flex items-start gap-4">
                <div className="p-2 rounded-[10px] bg-[var(--accent-soft)]">
                  <Icon className="h-5 w-5 text-accent" />
                </div>
                <div>
                  <h3 className="text-[0.875rem] font-semibold text-[var(--text)]">{title}</h3>
                  <p className="mt-0.5 text-[0.78rem] text-[var(--text-faint)]">{desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="social-identity" className="mx-auto grid w-full max-w-[1180px] scroll-mt-28 gap-6 px-2 py-8 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-0">
        <div className="tl-panel rounded-[18px] px-5 py-5">
          ...
          <div className="mt-4">
            <p className="text-[0.62rem] font-bold uppercase tracking-wider text-[var(--text-faint)] mb-2">Supported Platforms</p>
            <div className="flex flex-wrap gap-2">
              {socialIdentities.map(({ icon: Icon, name, status, color }) => (
                ...
                >
                  ...
                  <span className={`text-[0.78rem] font-medium ${status === "active" ? "text-[var(--text)]" : "text-[var(--text-faint)]"}`}>
                    {name}
                  </span>
                  {status === "active" && <CheckCircle2 className="h-3 w-3 text-accent" />}
                  {status === "coming" && <span className="text-[0.58rem] text-[var(--text-faint)]">Soon</span>}
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="flex flex-col gap-3">
          <div className="tl-panel rounded-[18px] px-4 py-4 flex-1">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-9 h-9 rounded-full bg-[#25D366]/10 flex items-center justify-center">
                <MessageCircle className="h-5 w-5 text-[#25D366]" />
              </div>
              <div>
                <p className="text-[0.875rem] font-semibold text-[var(--text)]">WhatsApp Verification</p>
                <p className="text-[0.62rem] text-[var(--text-faint)]">Currently Active</p>
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2 text-[0.78rem] text-[var(--text-soft)]">
                <CheckCircle2 className="h-3.5 w-3.5 text-accent" />
                <span>Last seen for trust signals</span>
              </div>
            </div>
          </div>
          <div className="tl-panel rounded-[18px] px-4 py-4 bg-[var(--surface-soft)] border-dashed">
            <p className="text-[0.78rem] font-semibold text-[var(--text-soft)] mb-1">Coming Soon</p>
            <p className="text-[0.68rem] text-[var(--text-faint)]">X Business accounts, Telegram, and additional social platforms will expand verification options.</p>
          </div>
        </div>
      </section>
      ...
      {/* SECTION: WHY ESCROW */}
      <section id="escrow-settlement" className="mx-auto grid w-full max-w-[1180px] scroll-mt-28 gap-6 px-2 py-8 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-0">
        <div className="min-w-0">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {[
            ...
            <article key={idx} className="tl-panel rounded-[18px] px-4 py-3 flex items-center gap-3">
              {/* @ts-ignore */}
              <Icon className="h-5 w-5 text-accent shrink-0" />
              <h3 className="text-[0.875rem] font-bold text-[var(--text)]">{String(title)}</h3>
            </article>
          ))}
        </div>
      </section>
      ...
      <section className="mx-auto w-full max-w-[1180px] scroll-mt-28 px-2 py-8 sm:px-6 lg:px-0">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-3">
          {securityFeatures.map(({ icon: Icon, title, desc }) => (
            <div key={title} className="tl-panel rounded-[18px] px-5 py-4 text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[var(--accent-soft)] mb-3">
                <Icon className="h-6 w-6 text-accent" />
              </div>
              <h3 className="text-[0.92rem] font-bold text-[var(--text)]">{title}</h3>
              <p className="mt-1 text-[0.78rem] text-[var(--text-faint)]">{desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="fees" className="mx-auto w-full max-w-[1180px] scroll-mt-28 px-2 py-8 sm:px-6 lg:px-0">
        ...
        <div className="mt-4 grid gap-6 lg:grid-cols-2 items-center">
          <div>
            ...
            <div className="mt-4 px-4 py-3 tl-field rounded-[14px] flex items-center gap-3">
              <Zap className="h-5 w-5 text-accent" />
              <div>
                <p className="text-[0.875rem] font-semibold text-[var(--text)]">Gasless by Design</p>
                <p className="text-[0.68rem] text-[var(--text-faint)]">Fees included in transfer amount</p>
              </div>
            </div>
          </div>
          <div className="tl-panel rounded-[18px] px-5 py-4">
            <h3 className="text-[0.92rem] font-bold text-[var(--text)] mb-3">Fee Distribution</h3>
            <div className="space-y-3">
              {feeDistribution.map(({ role, share, desc }) => (
                <div key={role} className="flex items-center gap-3 pb-3 border-b border-[var(--field-border)] last:border-b-0 last:pb-0 last:mb-0 mb-3">
                  <div className="w-14 h-14 rounded-[12px] bg-[var(--accent-soft)] flex items-center justify-center shrink-0">
                    <p className="text-[0.92rem] font-black text-accent">{share}</p>
                  </div>
                  <div>
                    <p className="text-[0.875rem] font-semibold text-[var(--text)]">{role}</p>
                    <p className="text-[0.68rem] text-[var(--text-faint)]">{desc}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section id="tsn" className="mx-auto w-full max-w-[1180px] scroll-mt-28 px-2 py-8 sm:px-6 lg:px-0">
        ...
        <div className="mt-4 grid gap-6 lg:grid-cols-2">
          ...
          <div className="tl-panel rounded-[18px] px-5 py-4">
            <h3 className="text-[0.92rem] font-black text-[var(--text)] mb-3">Transparent Fees</h3>
            <p className="text-[0.78rem] leading-6 text-[var(--text-soft)] mb-4">
            ...
            <div className="grid gap-2 border-t border-[var(--field-border)] pt-3">
              {transparentFeesRows.map(([label, note]) => (
                <div key={label} className="grid gap-2 border-b border-[var(--field-border)] pb-3 last:border-b-0 last:pb-0 md:grid-cols-[1fr_1.5fr]">
      ...
      {/* SECTION: TINS */}
      <section id="tins" className="mx-auto grid w-full max-w-[1180px] scroll-mt-28 gap-6 px-2 py-8 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-0">
        <div className="min-w-0">
        ...
        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
          {[
            ...
            <article key={String(title)} className="tl-panel rounded-[18px] px-4 py-3">
              {/* @ts-ignore */}
              <Icon className="h-5 w-5 text-accent" />
              <h3 className="tl-h3 mt-3">{String(title)}</h3>
              <p className="tl-body-sm mt-2">{String(body)}</p>
            </article>
          ))}
        </div>
      </section>
      ...
      <section id="developers" className="mx-auto w-full max-w-[1180px] scroll-mt-28 px-2 py-8 sm:px-6 lg:px-0">
        ...
        <div className="mt-4 grid gap-6 lg:grid-cols-2 items-center">
            ...
            <div className="mt-4 grid gap-2 sm:grid-cols-2">
              {sdkFeatures.map(({ icon: Icon, title, desc }) => (
                <div key={title} className="flex items-start gap-2">
                  <div className="p-1 rounded-[8px] bg-[var(--accent-soft)] shrink-0">
                    <Icon className="h-3.5 w-3.5 text-accent" />
                  </div>
                  <div>
                    <p className="text-[0.78rem] font-semibold text-[var(--text)]">{title}</p>
                    <p className="text-[0.62rem] text-[var(--text-faint)]">{desc}</p>
                  </div>
                </div>
              ))}
            </div>
            <div className="mt-4 flex flex-wrap gap-2">
              <Link href="/docs" className="tl-button-primary tl-btn inline-flex items-center gap-2 rounded-[14px] px-4 py-2 text-[0.78rem]">
                <BookOpen className="h-3.5 w-3.5" />
                SDK Docs
              </Link>
              <Link href="https://github.com/bigdreamsweb3/trustlink-pay" className="tl-button-secondary tl-btn inline-flex items-center gap-2 rounded-[14px] px-4 py-2 text-[0.78rem]">
          ...
          <article className="tl-panel overflow-hidden rounded-[18px]">
            ...
            <pre className="tl-code overflow-x-auto px-4 py-3 text-[0.78rem] leading-6">
              <code>
      ...
      <section id="status" className="mx-auto w-full max-w-[1180px] scroll-mt-28 px-2 py-8 sm:px-6 lg:px-0">
        ...
        <div className="mt-4 grid gap-6 lg:grid-cols-2">
          <div className="tl-panel rounded-[18px] px-5 py-5">
            <h2 className="tl-h2 mb-4">Current Status</h2>
            <div className="flex flex-wrap gap-2">
              {[
                "Wallet onboarding",
                ...
                <span key={feature} className="inline-flex items-center gap-1.5 bg-[var(--field-bg)] border border-[var(--field-border)] rounded-full px-3 py-1.5 text-[0.78rem] font-semibold text-[var(--text-soft)]">
                  <CheckCircle2 className="h-3.5 w-3.5 text-accent" />
                  {feature}
                </span>
              ))}
          ...
          <div className="space-y-3">
            ...
            {roadmapItems.map(({ status, title, desc }) => (
              <div key={title} className="tl-panel rounded-[18px] px-4 py-3 flex items-start gap-3">
                <div className={`shrink-0 w-7 h-7 rounded-full flex items-center justify-center ${
                  status === "live" ? "bg-accent/20" : status === "soon" ? "bg-warning/20" : "bg-[var(--surface-soft)]"
                }`}>
                  {status === "live" && <CheckCircle2 className="h-3.5 w-3.5 text-accent" />}
                  {status === "soon" && <Clock className="h-3.5 w-3.5 text-warning" />}
                  {status === "planned" && <TrendingUp className="h-3.5 w-3.5 text-[var(--text-faint)]" />}
                </div>
                <div>
                  <p className="text-[0.875rem] font-semibold text-[var(--text)]">{title}</p>
                  <p className="mt-0.5 text-[0.68rem] text-[var(--text-faint)]">{desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* SECTION: CTA */}
      <section className="mx-auto w-full max-w-[1180px] scroll-mt-28 px-2 pb-8 sm:px-6 lg:px-0">
        <div className="tl-panel rounded-[18px] px-5 py-5 md:px-6 text-center bg-gradient-to-b from-[var(--bg)] to-[var(--bg-soft)] border border-[var(--field-border)]">
          <h2 className="tl-h2 mb-3">Ready to Experience Identity-First Payments?</h2>
          <p className="text-[var(--text-soft)] max-w-[500px] mx-auto mb-5 text-[0.875rem]">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link href="/app" className="tl-button-primary tl-btn inline-flex items-center gap-2 rounded-[14px] px-5 py-2.5">
              Open Dapp <ArrowRight className="h-4 w-4" />
            </Link>
            <Link href="/docs" className="tl-button-secondary tl-btn inline-flex items-center gap-2 rounded-[14px] px-5 py-2.5">
              Read the Docs
            </Link>
          </div>
        </div>
      ...
      <footer className="mx-auto flex w-full max-w-[1180px] flex-col gap-5 border-t border-[var(--field-border)] py-8 px-2 sm:px-6 lg:px-0">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <strong className="text-[0.92rem] font-bold text-[var(--text)]">TrustLink Pay</strong>
            <p className="mt-0.5 text-[0.78rem] text-[var(--text-faint)]">Privacy and Confidence First on Solana</p>
          </div>
          <div className="flex flex-wrap gap-5">
            {footerLinks.map(({ label, href }) => (
              <Link key={label} href={href} className="text-[0.78rem] text-[var(--text-soft)] hover:text-[var(--text)] transition-colors">
                {label}
              </Link>
            ))}
          </div>
        </div>
        <div className="flex flex-wrap items-center justify-between gap-3 pt-4 border-t border-[var(--field-border)]">
          <div className="flex flex-wrap gap-4">
            {communityLinks.map(({ label, href, icon: Icon }) => (
              <a
                ...
                className="inline-flex items-center gap-1.5 text-[0.78rem] text-[var(--text-faint)] hover:text-accent transition-colors"
              >
...
function SectionLabel({ index, title }: { index: string; title: string }) {
  return (
    <div className="flex items-center gap-2">
      <span className="tl-badge tl-meta-label rounded-full px-2.5 py-0.5 text-[0.58rem] font-black">
        Section {index}
      </span>
      <span className="text-[0.78rem] font-black uppercase tracking-[0.14em] text-[var(--text-faint)]">{title}</span>
    </div>
  );
}