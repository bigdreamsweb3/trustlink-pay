...
export function CountrySearchModal({ open, query, countries, activeCountry, onClose, onQueryChange, onSelectCountry }: CountrySearchModalProps) {
  if (!open) return null;
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-6 tl-scrollbar-mobile-hidden">
          <div className="space-y-0.5">
            {countries.map((country) => {
              ...
              return (
                <button key={country.iso2} type="button"
