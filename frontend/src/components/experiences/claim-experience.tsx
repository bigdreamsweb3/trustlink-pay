        ...
        {loading ? (
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Link href="/app/identity?section=security" className="rounded-[18px] bg-[linear-gradient(135deg,#58f2b1,#9fffe4)] px-4 py-3.5 text-center tl-body-sm font-semibold text-[#04110a] cursor-pointer active:scale-[0.97] transition-transform">
                {identitySecurity?.recoveryWallet ? "Security" : "Add recovery"}
              </Link>
            </div>
          </div>
        ) : payment ? (
