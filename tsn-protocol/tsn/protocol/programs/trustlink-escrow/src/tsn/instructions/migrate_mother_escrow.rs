...
use crate::tsn::{
    ...
    state::MotherEscrow,
    utils::{default_fee_splits, default_tin_fee_splits, is_valid_split, is_valid_tin_fee_split},
};
...
pub fn migrate_mother_escrow(
    ...
    let (
        default_tin_verify_cranker,
        default_tin_submit_cranker,
        default_tin_team,
        default_tin_reserve_pool,
    ) = default_tin_fee_splits();
    ...
    offset += 2;
    data[offset..offset + 2].copy_from_slice(&default_tin_verify_cranker.to_le_bytes());
    offset += 2;
    data[offset..offset + 2].copy_from_slice(&default_tin_submit_cranker.to_le_bytes());
    offset += 2;
    data[offset..offset + 2].copy_from_slice(&default_tin_team.to_le_bytes());
    offset += 2;
    data[offset..offset + 2].copy_from_slice(&default_tin_reserve_pool.to_le_bytes());
    offset += 2;
