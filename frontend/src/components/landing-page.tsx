  ...
  return (
    <main className="app-shell tl-grid-overlay overflow-hidden bg-[var(--bg)] text-[14px] md:text-[15px]">
          ...
          <div className="tl-panel p-4 md:p-5">
            ...
            <div className="mt-5 grid gap-2">
              {[
                ...
                <div key={item} className="flex items-center gap-3 rounded-[11px] border border-[var(--field-border)] bg-[var(--field)] px-3 py-2.5">
                  <CheckCircle2 className="h-4 w-4 text-[var(--accent)]" />
                  <span className="text-[0.82rem] font-semibold text-[var(--text-soft)]">{item}</span>
                </div>
              ))}
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3">
            {heroStats.map((stat) => (
              <div key={stat.label} className="tl-field rounded-[14px] p-4">
                ...
                <strong className="mt-2 block text-[1.55rem] font-black text-[var(--text)]">{stat.value}</strong>
      ...
      <section id="tsn-privacy" className="mx-auto w-full max-w-[1180px] scroll-mt-28 py-12">
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-[0.95fr_1.05fr]">
          <div>
            ...
            <p className="mt-4 pr-3 text-[0.9rem] leading-7 text-[var(--text-soft)]">
      ...
      <section id="lp-yield" className="mx-auto w-full max-w-[1180px] scroll-mt-28 py-12">
        ...
        <p className="mt-4 pr-3 max-w-[660px] text-[0.9rem] leading-7 text-[var(--text-soft)]">
