...
const heroStats = [
  { icon: Fingerprint, label: "Identity layer", value: "TINS", note: "10-digit Transfer Identity Number, protects wallet addresses" },
  { icon: UserRoundCheck, label: "Confidence layer", value: "Verify", note: "Social Identities linked for verification" },
  { icon: Zap, label: "Sender fee model", value: "Gasless", note: "network + TSN protocol fee shown before send" },
  { icon: Clock, label: "Settlement target", value: "TSN <0.9s", note: "from intent to cranker proof" },
];
...
export function LandingPage() {
  ...
  return (
    <main className="app-shell overflow-hidden text-[14px] md:text-[15px]">
      ...
      {/* HERO SECTION */}
      <section id="tsn-protocol" className="mx-auto grid min-h-[calc(100dvh-7rem)] w-full max-w-[1180px] scroll-mt-28 items-center gap-10 px-0 pb-12 pt-2 lg:grid-cols-[0.98fr_1.02fr]">
        <div className="relative z-10">
          ...
          <h1 className="tl-display mt-5 max-w-[760px]">
            ...
            Crypto Transfers on Solana
          </h1>
          <p className="tl-body-lg mt-5 pr-3 max-w-[680px] text-[var(--text-soft)]">
            Send and receive crypto transfers without exposing wallet addresses, with confidence through linked social identities.
          </p>
          ...
          <div className="mt-6 grid grid-cols-2 gap-2">
            {heroStats.map((stat) => {
              ...
              return (
                <div key={stat.label} className="tl-field rounded-[10px] p-3 flex flex-col items-start gap-2">
                  <div className="flex items-center gap-2">
                    <IconComponent className="h-4 w-4 text-accent" />
                    <p className="text-[0.6rem] font-bold uppercase tracking-[0.12em] text-text-faint">{stat.label}</p>
                  </div>
                  <strong className="text-sm font-black text-[var(--text)]">{stat.value}</strong>
                  <p className="text-xs leading-4 text-[var(--muted)]">{stat.note}</p>
                </div>
              );
            })}
          </div>
      ...
      <section id="identity-first" className="border-t border-accent-border mx-auto grid w-full max-w-[1180px] scroll-mt-28 gap-8 px-0 py-14 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-0">
        <div className="min-w-0">
          ...
          <p className="tl-body mt-5 max-w-[680px]">
            Nigeria uses OPay. India uses UPI. Brazil uses Pix. Billions of transactions happen every day because they solved identity-first payments.
          </p>
        </div>
      ...
      <section id="tin-system" className="border-t border-accent-border mx-auto w-full max-w-[1180px] scroll-mt-28  px-0 py-14 sm:px-6 lg:px-0">
        ...
        <div className="mt-6 grid gap-8 lg:grid-cols-2">
          ...
          <div className="grid gap-4">
            {[
              ...
              <div key={title} className="tl-panel rounded-[22px] px-4 py-4 flex items-start gap-4">
      ...
      <section id="social-identity" className="border-t border-accent-border mx-auto w-full max-w-[1180px] scroll-mt-28  px-0 py-14 sm:px-6 lg:px-0">
        <div className="mt-6 grid gap-8 lg:grid-cols-2">
          <div >
            ...
            <div className="mt-6">
              ...
              <div className="flex flex-wrap gap-3">
                {socialIdentities.map(({ icon: Icon, name, status, color }) => (
                  <div
                    key={name}
                    className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border ${status === "active"
      ...
      {/* SECTION: WHY ESCROW */}
      <section id="escrow-settlement" className="border-t border-accent-border mx-auto grid w-full max-w-[1180px] scroll-mt-28 gap-8 px-0 py-14 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-0">
        <div className="min-w-0">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {[
            ...
            <article key={idx} className="tl-panel max-h-fit px-4 py-2 flex items-center gap-4">
              {/* @ts-ignore */}
      ...
      <section id="fees" className="border-t border-accent-border mx-auto w-full max-w-[1180px] scroll-mt-28  px-0 py-14 sm:px-6 lg:px-0">
      ...
      {/* SECTION: TSN & FEES */}
      <section id="tsn" className="border-t border-accent-border mx-auto w-full max-w-[1180px] scroll-mt-28  px-0 py-14 sm:px-6 lg:px-0">
      ...
      {/* SECTION: TINS */}
      <section id="tins" className="border-t border-accent-border mx-auto grid w-full max-w-[1180px] scroll-mt-28 gap-8  px-0 py-14 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-0">
        <div className="min-w-0">
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          {[
            ...
            <article key={String(title)} className="tl-panel rounded-[22px] px-4 py-4">
              {/* @ts-ignore */}
              <Icon className="h-5 w-5 text-accent" />
      ...
      {/* SECTION: DEVELOPERS */}
      <section id="developers" className="border-t border-accent-border mx-auto w-full max-w-[1180px] scroll-mt-28  px-0 py-14 sm:px-6 lg:px-0">
      ...
      <section id="status" className="border-t border-accent-border mx-auto w-full max-w-[1180px] scroll-mt-28  px-0 py-14 sm:px-6 lg:px-0">
        ...
        <div className="mt-6 grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-4">
            ...
            {roadmapItems.map(({ status, title, desc }) => (
              <div key={title} className="tl-panel rounded-[22px] px-4 py-4 flex items-start gap-4">
                <div className={`shrink-0 w-8 h-8 rounded-full flex items-center justify-center ${status === "live" ? "bg-accent/20" : status === "soon" ? "bg-warning/20" : "bg-[var(--surface-soft)]"
                  }`}>
